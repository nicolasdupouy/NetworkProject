...
public final class CommonConstants {
	 ...
	 * ################ ## Exceptions ## ################
	 */
	public static final String EXCEPTION_NAME_EXIT_EXCEPTION = "ExitException";
	public static final String EXCEPTION_NAME_PARAMETER_EXCEPTION = "ParameterException";
	public static final String EXCEPTION_NAME_PASSWORD_EXCEPTION = "PasswordException";
	public static final String EXCEPTION_NAME_MESSAGE_EXCEPTION = "MessageException";
	public static final String EXCEPTION_NAME_COMMUNICATION_EXCEPTION = "CommunicationException";
	
	public static final String EXCEPTION_CONNECTION_SOCKET = "Exception with socket";
